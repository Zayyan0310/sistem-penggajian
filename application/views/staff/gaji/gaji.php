...
<div class="container-fluid">
  ...
  <?php if ($bulan && $tahun): ?>
    ...
    <form method="POST" action="<?= base_url('Staff/PenggajianController/update_semua_gaji') ?>">
      <input type="hidden" name="bulan" value="<?= $bulan ?>">
      <input type="hidden" name="tahun" value="<?= $tahun ?>">
      <button type="submit" class="btn btn-danger mb-3">
        <i class="fas fa-sync-alt"></i> Update Semua Gaji Pegawai
      </button>
    </form>
            ...
            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?= base_url("Staff/PenggajianController/detail_slip?bulan=$bulan&tahun=$tahun&id_pegawai=" . $g->id_pegawai) ?>" 
