...
<body>
  <div class="container">
    <div class="img">
      <img src="<?php echo base_url(); ?>assets/img/perusahaan.png">
    </div>
    <div class="login-content">
      <form class="user" method="POST" action="<?php echo base_url('LoginController') ?>">
        <img src="<?php echo base_url(); ?>assets/img/man.svg">
        <h2 class="title">MUTIARA PAY</h2>
